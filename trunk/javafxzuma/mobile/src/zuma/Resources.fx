...
public def ballarray = [Image {
                        ...
                        url: "{__DIR__}images/ball/blueball.png" },
                        Image {
                        width : Config.BALL_DIAMETER
                        height: Config.BALL_DIAMETER
                        url: "{__DIR__}images/ball/greenball.png" },
                        Image {
                        width : Config.BALL_DIAMETER
                        height: Config.BALL_DIAMETER
                        url: "{__DIR__}images/ball/purpleball.png" },
                        Image {
                        width : Config.BALL_DIAMETER
                        height: Config.BALL_DIAMETER
                        url: "{__DIR__}images/ball/redball.png" },
                        Image {
                        width : Config.BALL_DIAMETER
                        height: Config.BALL_DIAMETER
                        url: "{__DIR__}images/ball/whiteball.png" },
                        Image {
                        width : Config.BALL_DIAMETER
                        height: Config.BALL_DIAMETER
                        url: "{__DIR__}images/ball/yellowball.png" }];
...
public def purgeffectImage = [Image {
                        width : Config.PURGE_BALL_DIAMETER
                        height: Config.PURGE_BALL_DIAMETER
